...
if __name__ == "__main__":
    ref = np.array(Image.open('D:/pythonProject2/data/010492.jpg').convert('LA'))[:, :, 0]  # ref #’LA'代表转化成灰度图
    dis = np.array(Image.open('D:/pythonProject2/data/010467.jpg').convert('LA'))[:, :, 0]  # dis
